    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">
          A quick view of staff access, provider activity, and appointment performance across the
          platform.
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Monitor administrative staff accounts and current access status.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary">
                {activeAdmins.length}/{admins.length}
              </Badge>
            </div>
            {admins.slice(0, 4).map((admin) => (
              <div
                key={admin.id}
                className="flex items-center justify-between rounded-xl bg-accent/50 p-3"
              >
                <div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Track registered healthcare providers and their availability status.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm text-muted-foreground">Active</span>
              <Badge variant="secondary">
                {activeDoctors.length}/{doctors.length}
              </Badge>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Review appointment requests and their latest booking outcomes.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="flex items-center justify-between">
