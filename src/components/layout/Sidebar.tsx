...
export default function Sidebar() {
  ...
  return (
    <div className="hidden h-screen w-72 flex-col border-r border-border/50 bg-card/50 px-6 py-8 backdrop-blur-sm lg:flex">
      ...
      <div className="flex-1 space-y-1.5">
        ...
        {user.role === "patient" && (
          <>
            ...
            <NavLink href="/find-doctors" icon={Search}>
              Find Doctors
            </NavLink>
            <NavLink href="/my-appointments" icon={CalendarDays}>
              My Appointments
            </NavLink>
            <div className="pt-4">
              <div className="mb-4 px-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground/60">
        ...
        {user.role === "doctor" && (
          <>
            <NavLink href="/doctor" icon={LayoutDashboard}>
              Dashboard
            </NavLink>
            <NavLink href="/doctor/schedule" icon={Calendar}>
              Manage Schedule
            </NavLink>
            <NavLink href="/doctor/appointments" icon={CalendarDays}>
              Appointments
            </NavLink>
            <div className="pt-4">
              <div className="mb-4 px-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground/60">
              ...
              <NavLink href="/doctor/profile" icon={User}>
                My Profile
              </NavLink>
            </div>
          </>
        ...
        {user.role === "admin" && (
          <>
            ...
            <NavLink href="/admin/stats" icon={BarChart3}>
              System Stats
            </NavLink>
          </>
        )}
      ...
      <div className="border-t border-border/50 pt-6">
        <div className="mb-4 flex items-center gap-3 px-2">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-primary/20 to-teal-500/20 text-lg font-bold text-primary">
